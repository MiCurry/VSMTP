...
int fillMessage(message_t *msg, char status_code[4], unsigned int ip_source, unsigned int ip_dest, char *user_srouce, char *user_to, char *message);
...
int fillMessageHeader(message_t *msg, char status_code[4], unsigned int ip_source, unsigned int ip_dest, char *user_source, char *user_dest, char *message){
    

    sprintf(msg->status_code, "%s", status_code);
    msg->ip_source = ip_source;
    msg->ip_dest = ip_dest;
